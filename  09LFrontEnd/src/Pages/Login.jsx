  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1d232a] font-sans">
      <div className="w-full max-w-md p-8">
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500 text-red-500 px-4 py-2 rounded-md mb-4 text-center">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div className="text-center mt-4 text-gray-400">
            ...
            <Link to="/signup" className="text-[#6366f1] hover:underline font-semibold">
              Sign Up
            </Link>
          </div>
